...
document.addEventListener("DOMContentLoaded", function () {
  // Function to open a popup automatically after 5 seconds
  ...
  // Automatically open the popup with the specified ID in 5 seconds
  // setTimeout(function () {
  //   openPopup("popupForm2");
  // }, 20000);

  // openPopup("popupForm2"); // Change 'popupForm1' to the ID of the popup you want to open automatically

  // Get all the close buttons
  var closeBtns = document.querySelectorAll(".closeBtn");

  // Loop through the close buttons and attach event listeners
